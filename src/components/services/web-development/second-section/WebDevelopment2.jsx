...
import '../../app-developement/second-section/AppDevelopment2.css';
import WebDevelopmentQuestionImage from '../../../../assets/images/app-development-assets/app_developmentwhy_choose_us_image.png';
    ...
    return (
        <div className="app-development2-container">
            ...
            <div className="app-development2-image-container">
                <img src={WebDevelopmentQuestionImage} alt="Why Choose Us?" className="app-development2-image" />
            </div>
        </div>
    );
};
